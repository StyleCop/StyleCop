...
namespace StyleCop.ReSharper710.QuickFixes.Layout
{
    ...
    public class SA1512QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1512SingleLineCommentsMustNotBeFollowedByBlankLineBulbItem { Description = "Remove blank line: " + this.Highlighting.ToolTip } };
        }
