...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1617QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1617VoidReturnValueMustNotBeDocumentedBulbItem { Description = "Remove <return> from header : " + this.Highlighting.ToolTip } };
        }
