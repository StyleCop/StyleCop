...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1619QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1618GenericTypeParametersMustBeDocumentedBulbItem { Description = "Insert <typeparam> into header : " + this.Highlighting.ToolTip } };
        }
