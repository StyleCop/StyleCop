...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1620QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1618GenericTypeParametersMustBeDocumentedBulbItem { Description = "Fix <typeparam> in header : " + this.Highlighting.ToolTip } };
        }
