...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1643QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1643DestructorSummaryDocumentationMustBeginWithStandardTextBulbItem { Description = "Insert Standard Destructor Summary Text : " + this.Highlighting.ToolTip } };
        }
