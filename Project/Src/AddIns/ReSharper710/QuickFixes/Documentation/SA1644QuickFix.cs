...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1644QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1644DocumentationHeadersMustNotContainBlankLinesBulbItem { Description = "Remove blank lines from documentation : " + this.Highlighting.ToolTip } };
        }
