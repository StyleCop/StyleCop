...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1626QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1626SingleLineCommentsMustNotUseDocumentationStyleSlashesBulbItem { Description = "Change '///' to '//' : " + this.Highlighting.ToolTip } };
        }
