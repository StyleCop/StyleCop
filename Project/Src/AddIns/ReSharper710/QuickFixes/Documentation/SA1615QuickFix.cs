...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1615QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1615ElementReturnValueMustBeDocumentedBulbItem { Description = "Insert <return> in header : " + this.Highlighting.ToolTip } };
        }
