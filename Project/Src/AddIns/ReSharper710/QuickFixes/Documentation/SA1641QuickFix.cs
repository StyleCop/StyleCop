...
namespace StyleCop.ReSharper710.QuickFixes.Documentation
{
    ...
    public class SA1641QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1641FileHeaderCompanyNameTextMustMatchBulbItem { Description = "Add company name to header : " + this.Highlighting.ToolTip } };
        }
