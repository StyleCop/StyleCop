...
namespace StyleCop.ReSharper610.QuickFixes.Ordering
{
    ...
    public class SA1211QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1211QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1211QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1211QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
