...
namespace StyleCop.ReSharper610.Options
{
    ...
    /// </summary>
    [OptionsPage(PID, "StyleCop", "StyleCop.ReSharper610.Resources.StyleCop.png", ParentId = "Tools")]
    public partial class StyleCopOptionsPage : UserControl, IOptionsPage
    {
        ...
        public static void ResetCodeStyleOptions(ISolution solution, JB::JetBrains.DataFlow.Lifetime lifetime)
        {
            ...
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("StyleCop.ReSharper610.Resources.ReorderingPatterns.xml"))
            {
        ...
        public static bool CodeStyleOptionsValid(IContextBoundSettingsStore settingsStore)
        {
            ...
            string reorderingPatterns;
            using (
                var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("StyleCop.ReSharper610.Resources.ReorderingPatterns.xml"))
            {
                using (var reader = new StreamReader(stream))
                {
                    reorderingPatterns = reader.ReadToEnd();
            ...
            if (solution != null)
            {
                ...
                if (
                    !GetCodeCleanupProfileSetting<bool>(codeCleanupInstance, styleCopProfile, "CSharpFormatDocComments", null))
                {
                    return false;
                }
