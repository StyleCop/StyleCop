...
namespace StyleCop.ReSharper.QuickFixes.Documentation
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SA1600QuickFix class that can handle <see cref="StyleCopHighlighting"/> .
        /// </summary>
        /// <param name="highlight">
        /// <see cref="StyleCopHighlighting"/> that has been detected. 
        /// </param>
        public SA1600QuickFix(StyleCopHighlighting highlight)
            : base(highlight)
        {
        }
