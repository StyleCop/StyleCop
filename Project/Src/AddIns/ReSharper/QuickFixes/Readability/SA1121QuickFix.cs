...
namespace StyleCop.ReSharper.QuickFixes.Readability
{
    ...
    public class SA1121QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1121QuickFix(StyleCopViolationError highlight) : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1121QuickFix(StyleCopViolationHint highlight) : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1121QuickFix(StyleCopViolationInfo highlight) : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1121QuickFix(StyleCopViolationSuggestion highlight) : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1121QuickFix(StyleCopViolationWarning highlight) : base(highlight)
        {
        }
