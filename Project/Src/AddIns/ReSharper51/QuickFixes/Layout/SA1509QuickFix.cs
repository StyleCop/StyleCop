...
namespace StyleCop.ReSharper51.QuickFixes.Layout
{
    ...
    using StyleCop.ReSharper51.BulbItems.Layout;
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1509QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1509QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1509QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1509QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1509QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1509QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
