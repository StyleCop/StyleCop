//-----------------------------------------------------------------------
// <copyright file="ConditionalLogicalExpression.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp.CodeModel
{
    ...
    public sealed class ConditionalLogicalExpression : Expression
    {
        ...
        internal ConditionalLogicalExpression(
            ...
            : base(proxy, ExpressionType.ConditionalLogical)
        {
        ...
        private void Initialize()
        {
            ...
            switch (o.SymbolType)
            {
                case CodeModel.OperatorType.ConditionalAnd:
                    this.operatorType.Value = Operator.And;
                    break;

                case CodeModel.OperatorType.ConditionalOr:
