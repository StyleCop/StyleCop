        ...
        public Operator OperatorType
        {
            get
            {
                ...
                if (!this.operatorType.Initialized)
                {
                    ...
                    {
                        if (operatorToken.SymbolType == CodeModel.OperatorType.Plus)
                        {
                            this.operatorType.Value = Operator.Positive;
                        }
                        else if (operatorToken.SymbolType == CodeModel.OperatorType.Minus)
                        {
                            this.operatorType.Value = Operator.Negative;
                        }
                        else if (operatorToken.SymbolType == CodeModel.OperatorType.Not)
                        {
                            this.operatorType.Value = Operator.Not;
                        }
                        else if (operatorToken.SymbolType == CodeModel.OperatorType.BitwiseCompliment)
                        {
