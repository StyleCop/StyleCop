...
namespace Microsoft.StyleCop.CSharp.CodeModel
{
    ...
    internal partial class CodeParser
    {
        ...
        /// <param name="preprocessorDefinitions">The optional preprocessor flags.</param>
        public CodeParser(CsLanguageService languageService, SymbolManager symbols, IDictionary<string, object> preprocessorDefinitions)
        {
            Param.AssertNotNull(languageService, "languageService");
        ...
        internal void ParseCodeModel()
        {
            ...
            this.document = new CsDocument(codeModelProxy, this.lexer.SourceCode.Name, this.lexer.SourceCode.Path);
