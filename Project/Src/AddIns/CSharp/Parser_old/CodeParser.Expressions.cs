...
namespace Microsoft.StyleCop.CSharp_old
{
    ...
    internal partial class CodeParser
    {
        ...
        [SuppressMessage(
            ...
            MessageId = "Microsoft.StyleCop.CSharp_old.SymbolManager.Combine(System.Int32,System.Int32,System.String,Microsoft.StyleCop.CSharp_old.SymbolType)",
        ...
        private Expression GetOtherExpression(Reference<ICodePart> parentReference, bool allowVariableDeclaration, bool unsafeCode)
        {
            ...
            if (variableDeclaration)
            {
                ...
                var variableDeclarationExpressionReference = new Reference<ICodePart>();
        ...
        private CastExpression GetCastExpression(bool unsafeCode)
        {
            ...
            // Create and return the expression.
            var expression = new CastExpression(partialTokens, type, castedExpression);
            expressionReference.Target = expression;
        ...
        private IncrementExpression GetUnaryIncrementExpression(bool unsafeCode)
        {
            ...
            // Create and return the expression.
            var expression = new IncrementExpression(partialTokens, valueExpression, IncrementExpression.IncrementType.Prefix);
            expressionReference.Target = expression;
        ...
        private DecrementExpression GetUnaryDecrementExpression(bool unsafeCode)
        {
            ...
            // Create and return the expression.
            var expression = new DecrementExpression(partialTokens, valueExpression, DecrementExpression.DecrementType.Prefix);
            expressionReference.Target = expression;
        ...
        private CheckedExpression GetCheckedExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.Checked, SymbolType.Checked, parentReference, expressionReference));
            ...
            // Create and return the expression.
            var expression = new CheckedExpression(partialTokens, innerExpression);
            expressionReference.Target = expression;
        ...
        private UncheckedExpression GetUncheckedExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.Unchecked, SymbolType.Unchecked, parentReference, expressionReference));
            ...
            // Create and return the expression.
            var expression = new UncheckedExpression(partialTokens, innerExpression);
            expressionReference.Target = expression;
        ...
        private Expression GetNewAllocationExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.New, SymbolType.New, parentReference, expressionReference));
        ...
        private NewExpression GetNewNonArrayTypeExpression(
            bool unsafeCode, Node<CsToken> firstTokenNode, Expression type, Reference<ICodePart> expressionReference)
        {
            Param.Ignore(unsafeCode);
            ...
            // Create and return the expression.
            var expression = new NewExpression(partialTokens, typeCreationExpression, initializer);
            expressionReference.Target = expression;
        ...
        private NewExpression GetNewAnonymousTypeExpression(bool unsafeCode, Node<CsToken> firstTokenNode, Reference<ICodePart> expressionReference)
        {
            ...
            // Create and return the expression.
            var expression = new NewExpression(partialTokens, null, initializer);
            expressionReference.Target = expression;
            ...
            bool unsafeCode, Node<CsToken> firstTokenNode, Expression type, Reference<ICodePart> expressionReference)
        {
            ...
            // Create and return the expression.
            var expression = new NewArrayExpression(partialTokens, type as ArrayAccessExpression, initializer);
            expressionReference.Target = expression;
        ...
        private CollectionInitializerExpression GetCollectionInitializerExpression(bool unsafeCode)
        {
            ...
            // Create and return the expression.
            var expression = new CollectionInitializerExpression(expressionTokens, initializerExpessions);
            expressionReference.Target = expression;
        ...
        private StackallocExpression GetStackallocExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            // The first symbol must be the new keyword.
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.Stackalloc, SymbolType.Stackalloc, parentReference, expressionReference));
            ...
            // Create and return the expression.
            var expression = new StackallocExpression(partialTokens, arrayAccess);
            expressionReference.Target = expression;
        ...
        private SizeofExpression GetSizeofExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.Sizeof, SymbolType.Sizeof, parentReference, expressionReference));
            ...
            // Create and return the expression.
            var expression = new SizeofExpression(partialTokens, typeTokenExpression);
            expressionReference.Target = expression;
        ...
        private TypeofExpression GetTypeofExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.Typeof, SymbolType.Typeof, parentReference, expressionReference));
            ...
            // Create and return the expression.
            var expression = new TypeofExpression(partialTokens, typeTokenExpression);
            expressionReference.Target = expression;
        ...
        private DefaultValueExpression GetDefaultValueExpression(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            Node<CsToken> firstTokenNode = this.tokens.InsertLast(
                this.GetToken(CsTokenType.DefaultValue, SymbolType.Default, parentReference, expressionReference));
        ...
        private CsTokenList GetQueryExpressionClauses(
            Reference<ICodePart> parentReference, bool unsafeCode, List<QueryClause> clauses, List<Variable> variables)
        {
            Param.AssertNotNull(parentReference, "parentReference");
            Param.Ignore(unsafeCode);
        ...
        private QueryFromClause GetQueryFromClause(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            // Create and return the clause.
            var queryFromClause = new QueryFromClause(
        ...
        private QueryWhereClause GetQueryWhereClause(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            // Create and return the clause.
            var clause = new QueryWhereClause(
                new CsTokenList(this.tokens, firstTokenNode, this.tokens.Last),
        ...
        private QueryJoinClause GetQueryJoinClause(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            // Create and return the clause.
            var clause = new QueryJoinClause(
                new CsTokenList(this.tokens, firstTokenNode, this.tokens.Last),
                variable,
                inExpression,
                onKeyExpression,
        ...
        private QueryGroupClause GetQueryGroupClause(Reference<ICodePart> parentReference, bool unsafeCode)
        {
            ...
            // Create and return the clause.
            var clause = new QueryGroupClause(
                new CsTokenList(this.tokens, firstTokenNode, this.tokens.Last),
                groupExpression,
                groupByExpression);
