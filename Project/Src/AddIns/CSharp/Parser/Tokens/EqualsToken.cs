//-----------------------------------------------------------------------
// <copyright file="EqualsToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class EqualsToken : Token
    {
        ...
        internal EqualsToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.Equals, location, generated)
        {
