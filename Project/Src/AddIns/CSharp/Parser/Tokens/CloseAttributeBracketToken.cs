//-----------------------------------------------------------------------
// <copyright file="CloseAttributeBracketToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class CloseAttributeBracketToken : BracketToken
    {
        ...
        internal CloseAttributeBracketToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.CloseAttributeBracket, location, generated)
        {
