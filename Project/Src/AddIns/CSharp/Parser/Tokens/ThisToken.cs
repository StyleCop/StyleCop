//-----------------------------------------------------------------------
// <copyright file="ThisToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class ThisToken : Token
    {
        ...
        internal ThisToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.This, location, generated)
        {
