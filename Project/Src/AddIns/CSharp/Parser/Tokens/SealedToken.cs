//-----------------------------------------------------------------------
// <copyright file="SealedToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class SealedToken : Token
    {
        /// <summary>
        ...
        internal SealedToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.Sealed, location, generated)
        {
