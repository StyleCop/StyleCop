//-----------------------------------------------------------------------
// <copyright file="UnsafeToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class UnsafeToken : Token
    {
        ...
        internal UnsafeToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.Unsafe, location, generated)
        {
