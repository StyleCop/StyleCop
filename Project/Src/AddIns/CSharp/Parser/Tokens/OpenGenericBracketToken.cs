//-----------------------------------------------------------------------
// <copyright file="OpenGenericBracketToken.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class OpenGenericBracketToken : BracketToken
    {
        /// <summary>
        ...
        internal OpenGenericBracketToken(string text, CodeLocation location, bool generated)
            : base(text, TokenType.OpenGenericBracket, location, generated)
        {
