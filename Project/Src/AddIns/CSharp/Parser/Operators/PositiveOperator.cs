//-----------------------------------------------------------------------
// <copyright file="PositiveOperator.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class PositiveOperator : OperatorSymbolToken
    {
        ...
        internal PositiveOperator(string text, CodeLocation location, bool generated)
            : base(text, OperatorCategory.Unary, OperatorType.Positive, location, generated)
        {
