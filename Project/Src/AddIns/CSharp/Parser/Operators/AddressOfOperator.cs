//-----------------------------------------------------------------------
// <copyright file="AddressOfOperator.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class AddressOfOperator : OperatorSymbolToken
    {
        ...
        internal AddressOfOperator(string text, CodeLocation location, bool generated)
            : base(text, OperatorCategory.Reference, OperatorType.AddressOf, location, generated)
        {
