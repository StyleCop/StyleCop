...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class RightShiftOperator : OperatorSymbolToken
    {
        ...
        internal RightShiftOperator(string text, CodeLocation location, bool generated)
            : base(text, OperatorCategory.Shift, OperatorType.RightShift, location, generated)
        {
