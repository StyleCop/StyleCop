//-----------------------------------------------------------------------
// <copyright file="LessThanOrEqualsOperator.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class LessThanOrEqualsOperator : OperatorSymbolToken
    {
        ...
        internal LessThanOrEqualsOperator(string text, CodeLocation location, bool generated)
            : base(text, OperatorCategory.Relational, OperatorType.LessThanOrEquals, location, generated)
        {
