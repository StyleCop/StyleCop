//-----------------------------------------------------------------------
// <copyright file="LogicalXorOperator.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class LogicalXorOperator : OperatorSymbolToken
    {
        ...
        internal LogicalXorOperator(string text, CodeLocation location, bool generated)
            : base(text, OperatorCategory.Logical, OperatorType.LogicalXor, location, generated)
        {
