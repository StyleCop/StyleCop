//-----------------------------------------------------------------------
// <copyright file="EndifDirective.cs" company="Microsoft">
...
namespace Microsoft.StyleCop.CSharp
{
    ...
    public sealed class EndifDirective : ConditionalCompilationDirective
    {
        ...
        internal EndifDirective(string text, CodeUnitProxy proxy, Expression body, CodeLocation location, bool generated)
