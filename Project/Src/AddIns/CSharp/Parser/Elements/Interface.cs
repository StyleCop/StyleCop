// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Interface.cs" company="http://stylecop.codeplex.com">
//   MS-PL
// </copyright>
// <license>
...
namespace StyleCop.CSharp
{
    ...
    public sealed class Interface : ClassBase
    {
        ...
        internal Interface(
            ...
            bool unsafeCode, 
            bool generated)
            : base(document, parent, ElementType.Interface, "interface " + declaration.Name, header, attributes, declaration, typeConstraints, unsafeCode, generated)
        {
