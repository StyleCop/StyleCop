...
namespace StyleCop.ReSharper513.QuickFixes.Layout
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1505QuickFix : QuickFixBase
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the SA1505QuickFix class that can 
        ...
        /// <summary>
        /// Initializes a new instance of the SA1505QuickFix class that can handle
