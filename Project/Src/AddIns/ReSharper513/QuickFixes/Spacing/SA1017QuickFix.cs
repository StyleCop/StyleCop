...
namespace StyleCop.ReSharper513.QuickFixes.Spacing
{
    ...
    using StyleCop.ReSharper513.BulbItems.Readability;
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1017QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1017QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1017QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1017QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1017QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1017QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
