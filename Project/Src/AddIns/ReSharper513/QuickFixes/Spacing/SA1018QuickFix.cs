...
namespace StyleCop.ReSharper513.QuickFixes.Spacing
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1018QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1018QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1018QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1018QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1018QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1018QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
