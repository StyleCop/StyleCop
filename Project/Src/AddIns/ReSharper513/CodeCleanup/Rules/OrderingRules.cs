...
namespace StyleCop.ReSharper513.CodeCleanup.Rules
{
    ...
    using StyleCop.ReSharper513.CodeCleanup.Styles;
    ...
    public class OrderingRules
    {
        ...
        {
            IList<IAccessorDeclaration> accessorDeclarations = declarationNode.AccessorDeclarations;
            ...
            IAccessorDeclaration newAccessor = firstAccessor.CopyElementWithResolve();
