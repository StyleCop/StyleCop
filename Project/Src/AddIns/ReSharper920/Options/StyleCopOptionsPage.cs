...
namespace StyleCop.ReSharper920.Options
{
    ...
    using StyleCop.ReSharper920.Core;
    ...
    public partial class StyleCopOptionsPage : UserControl, IOptionsPage
    {
        ...
        public static void CodeStyleOptionsReset(IContextBoundSettingsStore settingsStore)
        {
            ...
            settingsStore.SetValue((CSharpFormatSettingsKey key) => key.REDUNDANT_THIS_QUALIFIER_STYLE, ThisQualifierStyle2.ALWAYS_USE);
            ...
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("StyleCop.ReSharper920.Resources.ReorderingPatterns.xml"))
            {
        ...
        public static bool CodeStyleOptionsValid(IContextBoundSettingsStore settingsStore)
        {
            ...
            if (settingsStore.GetValue((CSharpFormatSettingsKey key) => key.REDUNDANT_THIS_QUALIFIER_STYLE) != ThisQualifierStyle2.ALWAYS_USE)
            {
                return false;
            }
