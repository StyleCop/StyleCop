...
namespace StyleCop.ReSharper920.QuickFixes.Spacing
{
    ...
    public class SA1000QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1000QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1000QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1000QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1000QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1000QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
