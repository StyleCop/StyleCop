...
namespace StyleCop.ReSharper920.QuickFixes.Documentation
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1605QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1605QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }

        /// <summary>
        /// Initializes a new instance of the SA1605QuickFix class that can handle
        /// <see cref="StyleCopHighlightingHint"/>.
        /// </summary>
        /// <param name="highlight">
        /// <see cref="StyleCopHighlightingHint"/>that has been detected.
        /// </param>
        public SA1605QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1605QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1605QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1605QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
