...
namespace StyleCop.ReSharper920.QuickFixes.Documentation
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1641QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1641QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1641QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1641QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1641QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1641QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
