// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SA1612QuickFix.cs" company="http://stylecop.codeplex.com">
//   MS-PL
// </copyright>
// <license>
...
namespace StyleCop.ReSharper920.QuickFixes.Documentation
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1612QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1612QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1612QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1612QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1612QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1612QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
