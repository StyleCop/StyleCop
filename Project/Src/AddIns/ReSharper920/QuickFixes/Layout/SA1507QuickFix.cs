...
namespace StyleCop.ReSharper920.QuickFixes.Layout
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1507QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1507QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1507QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1507QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1507QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1507QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
            ...
            this.BulbItems = new List<IBulbAction>
                                 {
                                     new SA1507CodeMustNotContainMultipleBlankLinesInARowBulbItem
                                         {
                                             Description =
                                                 "Remove line : " + this.Highlighting.ToolTip
                                         }
                                 };
        }
