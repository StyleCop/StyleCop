...
namespace StyleCop.ReSharper920.QuickFixes.Layout
{
    ...
    public class SA1500QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1500QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1500QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1500QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1500QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1500QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
