...
namespace StyleCop.ReSharper920.QuickFixes.Layout
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1516QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1516QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1516QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1516QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1516QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1516QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
                                     ...
                                     new FormatLineBulbItem
                                         {
                                             ...
                                             Description = "Insert blank line: " + this.Highlighting.ToolTip
                                         }
                                 };
        }
