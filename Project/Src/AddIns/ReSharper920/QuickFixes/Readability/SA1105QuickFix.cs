// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SA1105QuickFix.cs" company="http://stylecop.codeplex.com">
//   MS-PL
// </copyright>
// <license>
...
namespace StyleCop.ReSharper920.QuickFixes.Readability
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1105QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1105QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1105QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1105QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1105QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1105QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
