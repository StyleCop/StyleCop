...
namespace StyleCop.ReSharper920.QuickFixes.Readability
{
    ...
    public class SA1122QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1122QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }

        /// <summary>
        /// Initializes a new instance of the SA1122QuickFix class that can handle
        /// <see cref="StyleCopHighlightingHint"/>.
        /// </summary>
        /// <param name="highlight">
        /// <see cref="StyleCopHighlightingHint"/>that has been detected.
        /// </param>
        public SA1122QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
