...
namespace StyleCop.ReSharper920.QuickFixes.Readability
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1108QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1108QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1108QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1108QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1108QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1108QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
        ...
        protected override void InitialiseBulbItems()
        {
            this.BulbItems = new List<IBulbAction>
                                 {
                                     new SA1108BlockStatementsMustNotContainEmbeddedCommentsBulbItem
                                         {
                                             Description =
