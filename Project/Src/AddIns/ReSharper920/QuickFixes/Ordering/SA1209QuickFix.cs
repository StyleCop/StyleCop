...
namespace StyleCop.ReSharper920.QuickFixes.Ordering
{
    ...
    public class SA1209QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1209QuickFix(StyleCopHighlightingError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1209QuickFix(StyleCopHighlightingHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1209QuickFix(StyleCopHighlightingInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1209QuickFix(StyleCopHighlightingSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1209QuickFix(StyleCopHighlightingWarning highlight)
            : base(highlight)
        {
        }
