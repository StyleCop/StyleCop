...
namespace StyleCop.ReSharper920.CodeCleanup
{
    ...
    using StyleCop.ReSharper920.CodeCleanup.Descriptors;
    ...
    ///   We ensure that most of the ReSharper modules are run before we are.
    /// </summary>
    [CodeCleanupModule(ModulesBefore = new[] { typeof(UpdateFileHeader), typeof(HighlightingCleanupModule), typeof(OptimizeUsings), typeof(ReplaceByVar), typeof(ReformatCode) })]
