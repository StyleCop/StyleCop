...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace StyleCop.ReSharper920.BulbItems.Ordering
{
    ...
    using StyleCop.ReSharper920.CodeCleanup.Rules;
    ...
    public class OrderUsingsBulbItem : V5BulbItemImpl
    {
        ...
        public override void ExecuteTransactionInner(ISolution solution, ITextControl textControl)
        {
            ...
            OrderingOptions options = new OrderingOptions
                                          {
                                              AlphabeticalUsingDirectives = AlphabeticalUsingsStyle.Alphabetical.ToString(CultureInfo.InvariantCulture), 
                                              ExpandUsingDirectives = ExpandUsingsStyle.FullyQualify.ToString(CultureInfo.InvariantCulture)
                                          };
