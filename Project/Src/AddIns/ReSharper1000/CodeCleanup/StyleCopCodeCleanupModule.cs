...
namespace StyleCop.ReSharper1000.CodeCleanup
{
    ...
    using StyleCop.ReSharper1000.CodeCleanup.Descriptors;
    ...
    ///   We ensure that most of the ReSharper modules are run before we are.
    /// </summary>
    [CodeCleanupModule(ModulesBefore = new[] { typeof(UpdateFileHeader), typeof(CSharpHighlightingCleanupModule), typeof(OptimizeUsings), typeof(ReplaceByVarCodeCleanupModule), typeof(ReformatCode) })]
