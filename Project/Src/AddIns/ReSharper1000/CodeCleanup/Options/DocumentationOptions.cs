...
namespace StyleCop.ReSharper1000.CodeCleanup.Options
{
    ...
    public class DocumentationOptions : OptionsBase
    {
        ...
        public DocumentationOptions()
        {
            ...
            this.SA1633SA1641UpdateFileHeader = this.IsFileHeaderSettingDisabled
                ? UpdateFileHeaderStyle.Ignore.ToString(CultureInfo.InvariantCulture)
                : UpdateFileHeaderStyle.ReplaceCopyrightElement.ToString(CultureInfo.InvariantCulture);
        }
        ...
        public string SA1633SA1641UpdateFileHeader { get; set; }
