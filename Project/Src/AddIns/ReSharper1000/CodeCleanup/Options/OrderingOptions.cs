...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace StyleCop.ReSharper1000.CodeCleanup.Options
{
    ...
    public class OrderingOptions : OptionsBase
    {
        ...
        public OrderingOptions()
        {
            ...
            this.AlphabeticalUsingDirectives = AlphabeticalUsingsStyle.Alphabetical.ToString(CultureInfo.InvariantCulture);
            this.ExpandUsingDirectives = ExpandUsingsStyle.FullyQualify.ToString(CultureInfo.InvariantCulture);
        }
