    ...
    public static class IUsingDirectiveExtensions
    {
        ...
        internal static string GetFullyQualifiedNamespace(this IUsingDirective directive)
        {
            if (directive is IUsingAliasDirective)
            {
                ...
                INamespace aliasedNamespace = null;
                var aliasedSymbol = aliasDirective.DeclaredElement.GetAliasedSymbol();

                if (aliasedSymbol != null)
                {
                    aliasedNamespace = aliasedSymbol.Element as INamespace;
                }
            ...
            IUsingSymbolDirective namespaceDirective = directive as IUsingSymbolDirective;

            if (namespaceDirective != null)
            {
                INamespace impotedNamespace = null;
                var importedNamespaceSymbol = namespaceDirective.ImportedSymbol;

                if (importedNamespaceSymbol != null)
                {
                    impotedNamespace = importedNamespaceSymbol.Element as INamespace;
                }

                return impotedNamespace == null ? namespaceDirective.ImportedSymbolName.QualifiedName : impotedNamespace.QualifiedName;
            }
