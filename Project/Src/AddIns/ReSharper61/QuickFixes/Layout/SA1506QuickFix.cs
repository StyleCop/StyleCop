...
namespace StyleCop.ReSharper61.QuickFixes.Layout
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1506QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1506QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1506QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1506QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1506QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1506QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
