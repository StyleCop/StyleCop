...
namespace StyleCop.ReSharper61.QuickFixes.Documentation
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1628QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1628QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }

        /// <summary>
        /// Initializes a new instance of the SA1628QuickFix class that can handle
        /// <see cref="StyleCopViolationHint"/>.
        /// </summary>
        /// <param name="highlight">
        /// <see cref="StyleCopViolationHint"/>that has been detected.
        /// </param>
        public SA1628QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1628QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1628QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1628QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbItem> { new SA1628DocumentationTextMustBeginWithACapitalLetterBulbItem { Description = "Uppercase the first letter of documentation : " + this.Violation.ToolTip } };
        }
