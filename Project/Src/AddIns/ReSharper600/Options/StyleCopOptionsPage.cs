    ...
    public partial class StyleCopOptionsPage : UserControl, IOptionsPage
    {
        ...
        public StyleCopOptionsPage(IOptionsDialog dialog)
        {
            using (ReadLockCookie.Create())
            {
                ...
                {
                    this.Controls.Add(JetBrains.UI.Options.Helpers.Controls.CreateNoSolutionCueBanner());
                }
            }
        }
        ...
        public static bool CodeStyleOptionsValid(ISolution solution)
        {
            ...
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("StyleCop.ReSharper600.Resources.ReorderingPatterns.xml"))
            {
