...
namespace StyleCop.ReSharper600.QuickFixes.Layout
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1501QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1501QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1501QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1501QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1501QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1501QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
