...
namespace StyleCop.ReSharper600.QuickFixes.Layout
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1508QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1508QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1508QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1508QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1508QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1508QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
