...
namespace StyleCop.ReSharper600.QuickFixes.Ordering
{
    ...
    [ShowQuickFix]
    [QuickFix]
    public class SA1210QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1210QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1210QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1210QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1210QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1210QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
