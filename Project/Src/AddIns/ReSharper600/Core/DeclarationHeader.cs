...
namespace StyleCop.ReSharper600.Core
{
    ...
    public class DeclarationHeader
    {
        ...
        /// </param>
        /// <returns>
        /// A <see cref="bool"/> of whether a <c>>param</c> element is declared in the header.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A <see cref="bool"/> of whether a <see cref="ITypeParameter"/> is declared in the header.
        /// </returns>
