...
namespace StyleCop.ReSharper600.CodeCleanup.Rules
{
    ...
    using StyleCop.ReSharper600.CodeCleanup.Options;
    ...
    public class DocumentationRules
    {
        ...
        /// <see cref="Hashtable"/>of <c>param</c> elements that are not required.
        /// </param>
        ...
        /// </param>
        /// <param name="hashtable">
        /// <see cref="Hashtable"/>of <c>typeparam</c> that are not required.
        /// </param>
        ...
        /// <summary>
        /// Reorder the <see cref="IParameterDeclaration"/>.
        /// </summary>
        /// <param name="xmlNode">
        /// The xml node.
        /// </param>
