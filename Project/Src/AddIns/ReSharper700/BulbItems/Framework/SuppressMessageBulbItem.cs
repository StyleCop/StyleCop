...
namespace StyleCop.ReSharper700.BulbItems.Framework
{
                ...
                if (attributesOwnerDeclaration != null)
                {
                    ...
                    if (file != null)
                    {
                        ...
                        if (languageService != null)
                        {
                            ...
                            {
                                codeFormatter.FormatFile(file, CodeFormatProfile.DEFAULT, JB::JetBrains.Application.Progress.NullProgressIndicator.Instance);
                            }
                        }
                    }
                }
