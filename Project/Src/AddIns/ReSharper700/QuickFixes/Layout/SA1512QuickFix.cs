...
namespace StyleCop.ReSharper700.QuickFixes.Layout
{
    ...
    public class SA1512QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1512SingleLineCommentsMustNotBeFollowedByBlankLineBulbItem { Description = "Remove blank line: " + this.Violation.ToolTip } };
        }
