...
namespace StyleCop.ReSharper700.QuickFixes.Layout
{
    ...
    public class SA1515QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1515SingleLineCommentsMustBePrecededByBlankLineBulbItem { Description = "Insert blank line: " + this.Violation.ToolTip } };
        }
