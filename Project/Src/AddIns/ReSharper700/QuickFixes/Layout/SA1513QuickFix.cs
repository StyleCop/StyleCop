...
namespace StyleCop.ReSharper700.QuickFixes.Layout
{
    ...
    public class SA1513QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1513ClosingCurlyBracketMustBeFollowedByBlankLineBulbItem { Description = "Insert blank line: " + this.Violation.ToolTip } };
        }
