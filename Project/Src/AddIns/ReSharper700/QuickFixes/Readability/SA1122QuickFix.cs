...
namespace StyleCop.ReSharper700.QuickFixes.Readability
{
    ...
    //// [ShowQuickFix]
    [QuickFix]
    public class SA1122QuickFix : QuickFixBase
    {
        ...
        /// </param>
        public SA1122QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1122QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
