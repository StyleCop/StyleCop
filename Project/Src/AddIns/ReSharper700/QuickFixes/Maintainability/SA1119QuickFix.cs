...
namespace StyleCop.ReSharper700.QuickFixes.Maintainability
{
    ...
    public class SA1119QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1119QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1119QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1119QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1119QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1119QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1119StatementMustNotUseUnnecessaryParenthesisBulbItem { Description = "Remove Unnecessary Parenthesis : " + this.Violation.ToolTip }, };
        }
