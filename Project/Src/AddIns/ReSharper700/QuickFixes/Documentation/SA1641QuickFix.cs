...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1641QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1641FileHeaderCompanyNameTextMustMatchBulbItem { Description = "Add company name to header : " + this.Violation.ToolTip } };
        }
