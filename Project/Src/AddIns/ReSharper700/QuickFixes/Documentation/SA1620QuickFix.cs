...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1620QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1620QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1620QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1620QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1620QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1620QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1618GenericTypeParametersMustBeDocumentedBulbItem { Description = "Fix <typeparam> in header : " + this.Violation.ToolTip } };
        }
