...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1605QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1605PartialElementDocumentationMustHaveSummaryBulbItem { Description = "Insert <summary> into header : " + this.Highlighting.ToolTip } };
        }
