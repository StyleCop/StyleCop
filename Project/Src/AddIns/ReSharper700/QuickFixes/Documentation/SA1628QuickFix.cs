...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1628QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1628DocumentationTextMustBeginWithACapitalLetterBulbItem { Description = "Uppercase the first letter of documentation : " + this.Violation.ToolTip } };
        }
