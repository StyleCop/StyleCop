...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1617QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1617QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1617QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1617QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1617QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1617QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1617VoidReturnValueMustNotBeDocumentedBulbItem { Description = "Remove <return> from header : " + this.Violation.ToolTip } };
        }
