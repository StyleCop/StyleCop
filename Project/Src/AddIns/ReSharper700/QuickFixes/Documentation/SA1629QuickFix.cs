...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1629QuickFix : StyleCopQuickFixBase
    {
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1629DocumentationTextMustEndWithAPeriodBulbItem { Description = "Documentation text must end with a '.' : " + this.Violation.ToolTip } };
        }
