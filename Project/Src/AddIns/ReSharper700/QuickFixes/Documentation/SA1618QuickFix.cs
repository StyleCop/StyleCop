...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1618QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1618QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1618QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1618QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1618QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1618QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1618GenericTypeParametersMustBeDocumentedBulbItem { Description = "Insert <typeparam> into header : " + this.Violation.ToolTip } };
        }
