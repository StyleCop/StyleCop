...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1604QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1604QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1604QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1604QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1604QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1604QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1604ElementDocumentationMustHaveSummaryBulbItem { Description = "Insert <summary> into header : " + this.Violation.ToolTip } };
        }
