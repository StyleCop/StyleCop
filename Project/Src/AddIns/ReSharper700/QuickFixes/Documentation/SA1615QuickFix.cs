...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1615QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1615QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1615QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1615QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1615QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1615QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1615ElementReturnValueMustBeDocumentedBulbItem { Description = "Insert <return> in header : " + this.Violation.ToolTip } };
        }
