...
namespace StyleCop.ReSharper700.QuickFixes.Documentation
{
    ...
    public class SA1643QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1643QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1643QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1643QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1643QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1643QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new SA1643DestructorSummaryDocumentationMustBeginWithStandardTextBulbItem { Description = "Insert Standard Destructor Summary Text : " + this.Violation.ToolTip } };
        }
