...
namespace StyleCop.ReSharper700.QuickFixes.Ordering
{
    ...
    public class SA1213QuickFix : StyleCopQuickFixBase
    {
        ...
        /// </param>
        public SA1213QuickFix(StyleCopViolationError highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1213QuickFix(StyleCopViolationHint highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1213QuickFix(StyleCopViolationInfo highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1213QuickFix(StyleCopViolationSuggestion highlight)
            : base(highlight)
        {
        }
        ...
        /// </param>
        public SA1213QuickFix(StyleCopViolationWarning highlight)
            : base(highlight)
        {
        }
        ...
        {
            this.BulbItems = new List<IBulbAction> { new AccessorsMustFollowOrderBulbItem { Description = "Order accessors : " + this.Violation.ToolTip } };
        }
