namespace ReSharperBase.CodeCleanup.Options
{
    ...
    /// <summary>
    /// Base class for the ordering options - should be overridden so the defaults can be loaded as you'd expect for different ReSharper versions.
    /// </summary>
    public abstract class OrderingOptionsBase : OptionsBase
    {
        /// <summary>
