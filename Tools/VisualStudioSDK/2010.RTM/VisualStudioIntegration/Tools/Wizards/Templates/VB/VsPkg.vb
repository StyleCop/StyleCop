...
%ToolWindowItemEnd%
    ...
    ProvideEditorLogicalView(GetType(EditorFactory), "{7651a703-06e5-11d1-8ebd-00a0c90f26ea}"), _%EditorEnd%    
...
Private Sub MenuItemCallback(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(0, clsid, "%PackageName%", String.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()", Me.GetType().Name), String.Empty, 0, OLEMSGBUTTON.OLEMSGBUTTON_OK, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST, OLEMSGICON.OLEMSGICON_INFO, 0, result))
End Sub
%MenuItemEnd%
End Class
