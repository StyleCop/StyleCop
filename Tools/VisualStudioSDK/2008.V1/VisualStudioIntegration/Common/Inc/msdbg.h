...
enum AD7_HRESULT
{
    ...
    E_INTEROP_NOT_SUPPORTED_FOR_THIS_CLR__ = 0x80040032,
...
#define E_INTEROP_NOT_SUPPORTED_FOR_THIS_CLR _HRESULT_TYPEDEF_(E_INTEROP_NOT_SUPPORTED_FOR_THIS_CLR__)
...
#define E_INTEROP_WIN64 _HRESULT_TYPEDEF_(E_INTEROP_WIN64__)
