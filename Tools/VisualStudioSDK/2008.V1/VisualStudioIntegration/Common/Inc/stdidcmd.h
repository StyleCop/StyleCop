...
//this command is used for the Start Page Open: Project text
#define cmdidOpenProjectStartPage       321
#define cmdidWhatsNewStartPage          322
#define cmdidSamplesStartPage           323
#define cmdidStarterKitStartPage        324
#define cmdidHowDoIStartPage            325

#define cmdidCancelEZDrag               326

#define cmdidExploreExtensionsStartPage 327
