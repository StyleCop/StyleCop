...
/* Compiler settings for VSEditor.idl:
    Oicf, W1, Zp8, env=Win32 (32b run), target_arch=X86 8.00.0601 
...
typedef 
enum _VxClipboardLineInsertion
    {
        VxClipboardLineInsertionBeforeCurrentLine	= 0,
        VxClipboardLineInsertionAfterCurrentLine	= 1
    } 	VxClipboardLineInsertion;
