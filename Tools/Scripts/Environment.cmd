...
SET "RESHARPERINSTALLDIR=%ProgramFiles%\JetBrains\ReSharper\v8.1\Bin"

if "%IsWoW64%" == "1"  (
	SET "RESHARPERINSTALLDIR=%PROGRAMFILES(x86)%\JetBrains\ReSharper\v8.1\Bin"
)
...
echo JetBrains ReSharper 8.1 was found...
