//-----------------------------------------------------------------------
// <copyright file="AnalysisThreadTest.cs">
//   MS-PL
// </copyright>
// <license>
...
namespace VSPackageUnitTest
{
    ...
    public class AnalysisThreadTest
    {
        ...
        /// </summary>
        [TestMethod()]
        public void VsTestAnalyseProcFull()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void VsTestAnalyzeProcNotFull()
        {
        ...
        private static AnalysisThread_Accessor CreateAnalysisThread(bool isFull)
        {
            ...
            var target = new AnalysisThread_Accessor(isFull, false, projects, core); 
            return target;
        }
    }
}
