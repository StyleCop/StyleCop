...
namespace StyleCop
{
    ...
    public sealed class StyleCopConsole : StyleCopRunner
    {
        ...
        /// <summary>
        /// Indicates whether StyleCop should automatically fix the violations it finds.
        /// </summary>
        ...
        public StyleCopConsole(
            ...
            bool loadFromDefaultPath,
            object hostTag)
            : this(settings, writeResultsCache, outputFile, addInPaths, loadFromDefaultPath, false, hostTag)
        {
        ...
        /// <param name="loadFromDefaultPath">Indicates whether to load addins
        /// from the default application path.</param>
        /// <param name="autoFix">Indicates whether StyleCop should automatically fix the violations it finds, if possible.</param>
        /// <param name="hostTag">An optional tag which can be set by the host.</param>
        public StyleCopConsole(
            string settings,
            bool writeResultsCache,
        ...
        public bool Start(IList<CodeProject> projects, bool fullAnalyze)
        {
            ...
            try
            {
                ...
                if (this.autoFix)
                {
                    this.Core.AutoFix(projects, true);
                }
                else if (fullAnalyze)
                {
        ...
        private void LoadSettingsFiles(IEnumerable<CodeProject> projects)
        {
