...
namespace StyleCop
{
    ...
    internal static class V43Settings
    {
        ...
        private static string ConvertLegacyAddInName(string addInName)
        {
            ...
            const string LegacyPrefix1 = "Microsoft.SourceAnalysis";
            const string LegacyPrefix2 = "Microsoft.StyleCop";

            if (addInName.StartsWith(LegacyPrefix1, StringComparison.Ordinal))
            {
                return "StyleCop" + addInName.Substring(LegacyPrefix1.Length, addInName.Length - LegacyPrefix1.Length);
            }
            else if (addInName.StartsWith(LegacyPrefix2, StringComparison.Ordinal))
            {
                return "StyleCop" + addInName.Substring(LegacyPrefix2.Length, addInName.Length - LegacyPrefix2.Length);
            }
