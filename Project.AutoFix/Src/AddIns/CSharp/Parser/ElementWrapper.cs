//-----------------------------------------------------------------------
// <copyright file="ElementWrapper.cs">
//     MS-PL
// </copyright>
// <license>
    ...
    internal class ElementWrapper : ICodeElement
    {
        ...
        public IEnumerable<ICodeElement> ChildCodeElements
        {
            get
            {
                ...
                {
                    for (Element child = this.element.FindFirstChildElement(); child != null; child = child.FindNextSiblingElement())
                    {
        ...
        private static bool IsCodeAnalysisSuppression(Expression name)
        {
            ...
            {
                Token start = name.FindFirstChildToken();
                if (name.MatchTokensFrom(start, new string[] { "System", ".", "Diagnostics", ".", "CodeAnalysis", ".", "SuppressMessage" }) ||
                    name.MatchTokensFrom(start, new string[] { "System", ".", "Diagnostics", ".", "CodeAnalysis", ".", "SuppressMessageAttribute" }))
                {
                    return true;
                }
            }
