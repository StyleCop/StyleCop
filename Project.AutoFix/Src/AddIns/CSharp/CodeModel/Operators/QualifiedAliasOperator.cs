//-----------------------------------------------------------------------
// <copyright file="QualifiedAliasOperator.cs">
//     MS-PL
// </copyright>
// <license>
...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public sealed class QualifiedAliasOperator : OperatorSymbolToken
    {
        ...
        internal QualifiedAliasOperator(CsDocument document)
            : base(document, "::", OperatorCategory.Reference, OperatorType.QualifiedAlias)
        {
