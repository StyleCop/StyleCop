...
namespace StyleCop.CSharp.CodeModel.Collections
{
    ...
    internal partial class LinkedItemList<T> : ICollection<T> where T : class, ILinkNode<T>
    {
        ...
        public virtual void InsertAfter(T node, T nodeToInsertAfter)
        {
            ...
            if (this.head == null)
            {
                CsLanguageService.Debug.Assert(this.tail == null, "The head is null but the tail is not null");
                CsLanguageService.Debug.Assert(nodeToInsertAfter == null, "The head is null but nodeToInsertAfter is not null");
                CsLanguageService.Debug.Assert(this.Count == 0, "The list should be empty.");
            ...
            {
                CsLanguageService.Debug.Assert(this.tail != null, "Head is not null but tail is null");
                ...
                else
                {
                    ...
                    CsLanguageService.Debug.Assert(nodeToInsertAfter.LinkNode.Next != null, "The node should be in the middle of the list, having a next node.");
        ...
        public virtual void InsertBefore(T node, T nodeToInsertBefore)
        {
            ...
            {
                CsLanguageService.Debug.Assert(this.tail == null, "The head is null but the tail is not null");
                CsLanguageService.Debug.Assert(nodeToInsertBefore == null, "The head is null but nodeToInsertBefore is not null");
                CsLanguageService.Debug.Assert(this.Count == 0, "The list should be empty.");
            ...
            else
            {
                ...
                {
                    // The new node is going somewhere in the middle of the list.
                    CsLanguageService.Debug.Assert(nodeToInsertBefore.LinkNode.Previous != null, "The node should be somewhere in the middle of the list, having a previous node.");
        ...
        public virtual bool Remove(T node)
        {
            ...
            if (this.head == null)
            {
                ...
                CsLanguageService.Debug.Assert(this.tail == null, "The head of the list is null but the tail is not null");
            ...
            if (this.head.Equals(this.tail))
            {
                ...
                CsLanguageService.Debug.Assert(this.count == 1, "There is only one node but the count is not 1.");
            ...
            else if (this.head.Equals(node))
            {
                ...
                CsLanguageService.Debug.Assert(this.tail != null, "The head is not null but the tail is null");
            ...
            else if (this.tail.Equals(node))
            {
                ...
                CsLanguageService.Debug.Assert(this.head != null, "The tail is not null but the head is null");
