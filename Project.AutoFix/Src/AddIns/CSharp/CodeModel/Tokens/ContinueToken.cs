//-----------------------------------------------------------------------
// <copyright file="ContinueToken.cs">
//     MS-PL
// </copyright>
// <license>
...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public sealed class ContinueToken : SimpleToken
    {
        /// <summary>
        /// Initializes a new instance of the ContinueToken class.
        /// </summary>
        /// <param name="document">The parent document.</param>
        internal ContinueToken(CsDocument document)
            : base(document, "continue", TokenType.Continue)
        {
