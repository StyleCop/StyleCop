    ...
    public sealed class QueryGroupClause : QueryClause
    {
        ...
        public Expression GroupByExpression
        {
            get
            {
                ...
                {
                    this.Initialize();
                    CsLanguageService.Debug.Assert(this.groupByExpression.Value != null, "Failed to initialize");
                }
        ...
        private void Initialize()
        {
            ...
            this.expression.Value = groupToken.FindNextSiblingExpression();
            ...
            this.groupByExpression.Value = by.FindNextSiblingExpression();
