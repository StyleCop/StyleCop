...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public partial class VariableDeclaratorExpression : IVariable
    {
        ...
        public string VariableName
        {
            get
            {
                return this.Identifier == null ? string.Empty : this.Identifier.Text;
            }
        }
        ...
        public VariableModifiers VariableModifiers
        {
            get
            {
                ...
                VariableDeclarationStatement parent = this.FindParentStatement() as VariableDeclarationStatement;
