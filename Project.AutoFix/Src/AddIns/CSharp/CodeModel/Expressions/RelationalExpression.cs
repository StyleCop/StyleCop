//-----------------------------------------------------------------------
// <copyright file="RelationalExpression.cs">
//   MS-PL
// </copyright>
// <license>
...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public abstract class RelationalExpression : Expression
    {
            ...
            : base(proxy, (int)type)
        {
            ...
            CsLanguageService.Debug.Assert(System.Enum.IsDefined(typeof(RelationalExpressionType), this.RelationalExpressionType), "The type is invalid.");
        ...
        /// </summary>
        public RelationalExpressionType RelationalExpressionType
        {
            get
            {
                return (RelationalExpressionType)(this.FundamentalType & (int)FundamentalTypeMasks.RelationalExpression);
            }
        }
