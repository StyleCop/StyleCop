//-----------------------------------------------------------------------
// <copyright file="ArrayInitializerExpression.cs">
//     MS-PL
// </copyright>
// <license>
...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public sealed class ArrayInitializerExpression : Expression
    {
            ...
            : base(proxy, ExpressionType.ArrayInitializer)
        {
            ...
            CsLanguageService.Debug.Assert(initializers.IsReadOnly, "The initializers collection should be read-only.");
        }
        ...
        public ICollection<Expression> Initializers
        {
            get
            {
                ...
                if (!this.initializers.Initialized)
                {
                    ...
                    Expression expression = this.FindFirstChildExpression();
                    if (expression == null)
                    {
                    ...
                    while (true)
                    {
                        ...
                        expression = comma.FindNextSiblingExpression();
                        if (expression == null)
                        {
                            break;
                        }
