...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public abstract class ConditionalLogicalExpression : Expression
    {
        ...
        /// </summary>
        public ConditionalLogicalExpressionType ConditionalLogicalExpressionType
        {
            get
            {
                return (ConditionalLogicalExpressionType)(this.FundamentalType & (int)FundamentalTypeMasks.ConditionalLogicalExpression);
            }
        }
