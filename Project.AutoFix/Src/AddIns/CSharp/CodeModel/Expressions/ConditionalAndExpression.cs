//-----------------------------------------------------------------------
// <copyright file="ConditionalAndExpression.cs">
//     MS-PL
// </copyright>
// <license>
...
{
    /// <summary>
    /// An expression representing a conditional AND operation.
    /// </summary>
    public sealed class ConditionalAndExpression : ConditionalLogicalExpression
    {
        /// <summary>
