//-----------------------------------------------------------------------
// <copyright file="NotEqualToExpression.cs">
//     MS-PL
// </copyright>
// <license>
...
{
    /// <summary>
    /// An expression representing a not-equal-to operation.
    /// </summary>
    public sealed class NotEqualToExpression : RelationalExpression
    {
        /// <summary>
