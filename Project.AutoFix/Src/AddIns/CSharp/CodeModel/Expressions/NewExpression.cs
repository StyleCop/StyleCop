//-----------------------------------------------------------------------
// <copyright file="NewExpression.cs">
//     MS-PL
// </copyright>
// <license>
    ...
    public sealed class NewExpression : Expression
    {
            ...
            : base(proxy, ExpressionType.New)
        {
            ...
            Param.Assert(
                ...
                typeCreationExpression.ExpressionType == CodeModel.ExpressionType.QualifiedAlias ||
        ...
        public Expression TypeCreationExpression
        {
            get
            {
                ...
                {
                    this.Initialize();
                    CsLanguageService.Debug.Assert(this.typeCreationExpression.Value != null, "Failed to initialize");
                }
        ...
        public Expression InitializerExpression
        {
            get
            {
                ...
                {
                    this.Initialize();
                    CsLanguageService.Debug.Assert(this.initializerExpression.Value != null, "Failed to initialize");
                }
