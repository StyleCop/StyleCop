//-----------------------------------------------------------------------
// <copyright file="GreaterThanExpression.cs">
//     MS-PL
// </copyright>
// <license>
...
{
    /// <summary>
    /// An expression representing a greater-than operation.
    /// </summary>
    public sealed class GreaterThanExpression : RelationalExpression
    {
        /// <summary>
