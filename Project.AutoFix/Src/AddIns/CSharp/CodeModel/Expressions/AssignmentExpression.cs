...
namespace StyleCop.CSharp.CodeModel
{
    ...
    public abstract class AssignmentExpression : Expression
    {
        ...
        /// </summary>
        public AssignmentExpressionType AssignmentExpressionType
        {
            get
            {
                return (AssignmentExpressionType)(this.FundamentalType & (int)FundamentalTypeMasks.AssignmentExpression);
            }
        }
