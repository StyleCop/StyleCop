...
namespace StyleCop.CSharp.CodeModel
{
    ...
    internal class CodeReader
    {
        ...
        private bool LoadBuffer(int count)
        {
            ...
            {
                CsLanguageService.Debug.Assert(this.charBuffer != null && this.charBuffer.Length > this.position + count - 1, "The buffer position is invalid.");
                return true;
            }
            ...
            int numberOfCharactersRead = this.code.Source.ReadBlock(newBuffer, leftOverCharacterCount, CharacterBlockSize);
