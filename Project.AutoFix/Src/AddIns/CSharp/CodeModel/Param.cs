...
namespace StyleCop.CSharp.CodeModel
{
    ...
    internal delegate string ParamErrorTextHandler();
    ...
    [SuppressMessage(
        ...
        MessageId = "Param",
        Justification = "This name represents a Parameter, and should be short as it is used often.")]
    [SuppressMessage("StyleCop.Internal.ParamCheck", "*", Justification = "Not applicable.")]
    internal sealed class Param
    {
        ...
        /// </summary>
        /// <param name="test">The test for validity.</param>
        ...
        public static void AssertValidIndex(bool test, string parameterName, string exceptionMessage)
        {
            ...
            if (test == false)
            {
                if (!CsLanguageService.Debug.ThrowOnAssert)
                {
                    CsLanguageService.Debug.Assert(test, parameterName, exceptionMessage);
                }
        ...
        /// <param name="parameter">The collection to check.</param>
        /// <param name="parameterName">The name of the collection paramater.</param>
        /// <typeparam name="T">The type within the collection parameter.</typeparam>
        [Conditional("DEBUG")]
        public static void AssertValidCollection<T>(ICollection<T> parameter, string parameterName)
        {
            Param.Ignore(parameter);
            Param.RequireValidCollection(parameter, parameterName);
        }
        ...
        /// </summary>
        /// <param name="number">The number to check.</param>
        /// <param name="minimum">The number must be greater than this value.</param>
        /// <param name="parameterName">The name of the number parameter.</param>
        [Conditional("DEBUG")]
        ...
        /// </summary>
        /// <param name="number">The number to check.</param>
        /// <param name="minimum">The number must be greater than or equal to this value.</param>
        /// <param name="parameterName">The name of the number parameter.</param>
        [Conditional("DEBUG")]
        ...
        /// </summary>
        /// <param name="number">The number to check.</param>
        /// <param name="maximum">The number must be less than this value.</param>
        /// <param name="parameterName">The name of the number parameter.</param>
        [Conditional("DEBUG")]
        ...
        /// </summary>
        /// <param name="number">The number to check.</param>
        /// <param name="maximum">The number must be less than or equal to this value.</param>
        /// <param name="parameterName">The name of the number parameter.</param>
        [Conditional("DEBUG")]
        ...
        /// </summary>
        /// <param name="number">The number to check.</param>
        /// <param name="low">The valid low end range.</param>
        /// <param name="high">The valid high end range.</param>
        /// <param name="parameterName">The name of the number parameter.</param>
        [Conditional("DEBUG")]
        ...
        public static void Require(bool test, string parameterName, ParamErrorTextHandler errorTextHandler)
        {
            ...
            if (test == false)
            {
                ...
                if (!CsLanguageService.Debug.ThrowOnAssert)
                {
                    CsLanguageService.Debug.Assert(test, parameterName, message);
                }
        ...
        public static void RequireNotNull(object parameter, string parameterName, ParamErrorTextHandler errorTextHandler)
        {
            ...
            if (parameter == null)
            {
                ...
                if (!CsLanguageService.Debug.ThrowOnAssert)
                {
                    CsLanguageService.Debug.Assert(false, parameterName, message);
                }
        ...
        /// <param name="parameterName">The name of the collection paramater.</param>
        /// <typeparam name="T">The type within the collection parameter.</typeparam>
        public static void RequireValidCollection<T>(ICollection<T> parameter, string parameterName)
        {
            Param.Ignore(parameterName);
            Param.Require(parameter != null && parameter.Count > 0, parameterName, delegate { return ParamStrings.CollectionCannotBeEmptyOrNull; });
        }
        ...
        public static void RequireGreaterThan(int number, int minimum, string parameterName)
        {
            ...
            if (number <= minimum)
            {
                ...
                if (!CsLanguageService.Debug.ThrowOnAssert)
                {
                    CsLanguageService.Debug.Assert(false, parameterName, string.Format(CultureInfo.CurrentCulture, message, minimum));
                }
        ...
        public static void RequireLessThan(int number, int maximum, string parameterName)
        {
            ...
            if (number >= maximum)
            {
                ...
                if (!CsLanguageService.Debug.ThrowOnAssert)
                {
                    CsLanguageService.Debug.Assert(false, parameterName, string.Format(CultureInfo.CurrentCulture, message, maximum));
                }
        ...
        /// be verified.
        /// </summary>
        /// <param name="values">The list of parameters to ignore.</param>
        [Conditional("DEBUG")]
