...
namespace StyleCop.VisualStudio
{
    ...
    internal class AnalysisThread
    {
        ...
        /// <summary>
        /// True if fix is being performed.
        /// </summary>
        ...
        public AnalysisThread(bool full, bool autoFix, IList<CodeProject> projects, StyleCopCore core)
        {
            Param.Ignore(full);
        ...
        public void AnalyzeProc()
        {
            try
            {
                if (this.autoFix)
                {
                    this.core.AutoFix(this.projects, true);
                }
                else if (this.full)
                {
